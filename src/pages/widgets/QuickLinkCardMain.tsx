            ...
            <div className="col">
                <div className="card">
                        <div className="card-body p-3">
                          <div className="row">
                            <Link to="/2/equipment-library" className="col-lg-3 col-sm-6 card-right" onClick={()=>toggleMenu('equipment-library','')}>
                                <h6>Equipment Management</h6>
                            </Link>
                            <Link to="/2/work-orders" className="col-lg-3 col-sm-6 card-right" onClick={()=>toggleMenu('wo','')}>
                                <h6>Work Orders</h6>
                            </Link>
                            <Link to="/2/clinical-engineering-report" className="col-lg-3 col-sm-6 card-right" onClick={()=>toggleMenu('reports','')}>
                                <h6>Reports</h6>
                            </Link>
                            <Link to="/2/departments" className="col-lg-3 col-sm-6 card-left" onClick={()=>toggleMenu('departments','')}>
