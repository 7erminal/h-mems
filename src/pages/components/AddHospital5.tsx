...
const AddHospital5: React.FC<Props> = ({show, handleClose, toggle})=>{
    ...
    <Modal.Body>
        <Form onSubmit={(e: React.FormEvent<HTMLFormElement>)=>submitForm(e)}>
            <Row className="my-2">
                <Col xs={12} md={12}>
                    <small>DOES THE HOSPITAL HAVE A WEBSITE?</small>
                </Col>
            </Row>
            <Row className="mt-2">
                <Col>
                    <FloatingLabel
                        ...
                        className="mb-3"
                    >
                        <Form.Control placeholder="Website" value={institutionContext?.hospitalWebsite} onChange={(e)=>institutionContext?.setHospitalWebsite(e.target.value)} />
                    </FloatingLabel>
                </Col>
            </Row>
            ...
            <Row className="mt-4">
                <Col style={{justifyContent: 'right', display: 'flex'}}>
                    <Button className="primary-button" onClick={()=>toggle("ADD", "ADDHOSP5")}>Add Hospital</Button>
                </Col>
            </Row>
        </Form>
    </Modal.Body>
