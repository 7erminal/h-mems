...
const SideBar: React.FC = ()=>{
    ...
    <div className="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul className="navbar-nav">
        ...
        <li className="nav-item">
          <Link className={ appContext?.currentPage=="woch" ? "nav-link  active" : "nav-link"} onClick={()=>appContext?.showSideNav('woch')} to="/work-order">
            <div className="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li className="nav-item">
          <Link className={ appContext?.currentPage=="wo" ? "nav-link  active" : "nav-link"} onClick={()=>appContext?.showSideNav('wo')} to="/work-order">
            <div className="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i className="ni ni-world-2 text-danger text-sm opacity-10"></i>
            </div>
            <span className="nav-link-text ms-1">Work Order</span>
          </Link>
        </li>
